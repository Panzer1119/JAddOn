...
public class ImageUtils {
    ...
    public static Color[] getLinearGradient(Color color_start, Color color_stop, int steps) {
        ...
        double r_div = ((color_stop.getRed() - color_start.getRed()) / (steps - 1.0));
        double g_div = ((color_stop.getGreen() - color_start.getGreen()) / (steps - 1.0));
        double b_div = ((color_stop.getBlue() - color_start.getBlue()) / (steps - 1.0));
